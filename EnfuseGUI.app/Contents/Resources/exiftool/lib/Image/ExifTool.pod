...
FLAC, File, Flash, FlashPix, FotoStation, GIF, GeoTiff, HTML, ICC_Profile,
ID3, IPTC, ITC, JFIF, JPEG, Jpeg2000, LNK, Leaf, M2TS, MIE, MIFF, MNG, MPC,
MPEG, MPF, MakerNotes, Meta, PDF, PICT, PNG, PhotoMechanic, Photoshop,
PostScript, PrintIM, QuickTime, RAF, RIFF, Rawzor, Real, SVG, SigmaRaw,
Stim, Vorbis, XML, XMP, ZIP
...
Minolta, MinoltaRaw, NITF, Nikon, NikonCapture, NikonCustom, NikonPreview,
NikonScan, Olympus, PDF, PICT, PNG, Panasonic, Pentax, PhotoMechanic,
Photoshop, PictureInfo, PostScript, PrintIM, ProfileIFD, QuickTime, RAF,
...
SRF#, SVG, Sanyo, Scalado, Sigma, SigmaRaw, Sony, Stim, SubIFD, System,
Track#, Vorbis, XML, XMP, XMP-DICOM, XMP-MP, XMP-PixelLive, XMP-acdsee,
XMP-album, XMP-aux, XMP-cc, XMP-crs, XMP-dc, XMP-dex, XMP-exif,
XMP-iptcCore, XMP-iptcExt, XMP-lr, XMP-mediapro, XMP-microsoft, XMP-pdf,
XMP-pdfx, XMP-photomech, XMP-photoshop, XMP-plus, XMP-prism, XMP-prl,
XMP-pur, XMP-rdf, XMP-tiff, XMP-x, XMP-xmp, XMP-xmpBJ, XMP-xmpDM, XMP-xmpMM,
